      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div
              className={`animate-on-scroll fade-left bg-gray-50 p-8 rounded-2xl shadow-lg transform transition-all duration-1000 ${
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                <input
                  ...
                  required
                  className="contact-input w-full h-14 px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <input
                  type="tel"
                  name="phone"
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  className="contact-input w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                ></textarea>
            ...
            {/* Image */}
            <div
              className={`animate-on-scroll fade-right relative w-full h-64 lg:h-96 rounded-2xl overflow-hidden shadow-lg transform transition-all duration-1000 ${
                animate ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"
              }`}
            >
